...
<head>
    ...
    <title>Akomart Backoffice - Forget Password</title>
            ...
            <div class="container p-5">
                <div class="row p-5">
                    <div class="col-md-12 pl-5">
                        <p class="content-forget">Forget Your Password ?</p>
                    </div>
                    <div class="col-md-12 pl-5">
                        <p class="text-forget">Masukkan email kamu pada input dibawah ini untuk melakukan <br> reset password</p>
                    </div>
                    <div class="col-md-12 pl-5">
                        <form action="{{route('post.forget.password')}}" class="form-custom form stacked" method="POST" id="formForgetPassword" ajax="true">
                            <div class="row">
                                <div class="col-md-11 p-0 mt-2">
                                    <div class="form-group">
                                        <label for="">Email</label>
                                        <div class="with-error">
                                            <input type="text" name="email" id="email" class="form-control" placeholder="Masukkan email kamu">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 p-0">
                                    <button type="submit" class="btn-login w-100 disabled" disabled id="loginForget">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-custom">
            <div class="modal-content content-footer">
                <div class="modal-body">
                    <center>
                        <img src="{{asset('image/icon-forget.svg')}}" class="mt-3">
