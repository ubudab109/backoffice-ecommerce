...
<body bgcolor="#000" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="emailContainer" style="max-width:600px;margin:0 auto;"
    bgcolor="#ffffff">
    <tr>
      <td align="center" valign="top" id="emailContainerCell">
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="emailHeader"
          style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;background: #fff;padding: 15px; background-color:#0E0E26;">
          <tr>
                ...
                <tr>
                  <td valign="top">
                    <div mc:edit="header_logo">
                      <a href="#">
                        <img src="{{asset('image/navbar/logo.svg')}}" alt="" style="width:25%;">
                      </a>
                    </div>
                  </td>
                </tr>
        ...
        <!-- Start Email Header Area -->
        <table border="0" cellpadding="0" cellspacing="0" id="emailHeader"
          style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;background: #605ca8;padding: 15px;">
          <tr>
            <td align="center" valign="top">
              <table border="0" cellpadding="0" cellspacing="0" mc:repeatable="banner" mc:variant="banner"
                style="text-align: center;">
                <tr>
                  <td valign="top">
                    <h2 style="margin-bottom: 0;font-size: 30px;color: #fff;">{{__('Welcome to')}} {{ config('app.name') }}</h2>
                    <p style="margin-top: 5px;color: #fff;font-size: 30px;">{{__('This is an important message for
                      you')}}</p>
                  </td>
                </tr>
              </table>
