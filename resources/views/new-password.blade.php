            ...
            <div class="container p-5">
                <div class="row p-5">
                    <div class="col-md-12 pl-5">
                        <p class="content-forget">Input New Password</p>
                    </div>
                    <div class="col-md-12 pl-5">
                        <form action="{{route('post.new.password')}}" class="form-custom form stacked" method="POST" id="formNewPassword" ajax="true">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-7 p-0"></div>
                                    <div class="col-md-4 p-0">
                                        <button type="submit" class="btn-login w-100 disabled" disabled id="loginNew">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
