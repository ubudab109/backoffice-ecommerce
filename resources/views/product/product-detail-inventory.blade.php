...
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card card-custom">
      <div class="row">
        <div class="col-md-6">
          <p class="title-text pl-2">Inventory Product</p>
        </div>
      </div>
      <hr class="hr-custom">
      <div class="row">
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          <p class="title-text pl-2" style="font-weight: bold">Inventory List</p>
        </div>
      </div>
      <div class="row mb-5">
        <div class="col-md-12">
          <div class="col-md-12 pl-4 pr-4 table-responsive">
            <table class="table-custom-border">
              <thead>
                <tr>
                  <th class="bordered text-center align-middle text-xl-th">Agen</th>
                  <th class="bordered text-center align-middle text-xl-th">Note</th>
                  <th class="bordered text-center align-middle text-xl-th">Inventory</th>
                </tr>
              </thead>
              <tbody>
                @php
                ...
                @foreach ($inventories as $inventory)
                    @php
                        $totalInventory += $inventory->qty
                    @endphp
                    <tr>
                      <td class="bordered text-center align-middle">{{$inventory->creator->userAdmin->name}}</td>
                      <td class="bordered text-center align-middle">{{$inventory->note}}</td>
                      <td class="bordered text-center align-middle">{{$inventory->qty}}</td>
                    </tr>
                @endforeach
              </tbody>
              <tfoot>
                <tr>
                  <td colspan="2" style="text-align: end; font-weight: bold">Sum All Inventory</td>
                  <td class="text-center align-middle" style="font-weight: bold">{{$totalInventory}}</td>
                </tr>
              </tfoot>
            </table>
          </div>
